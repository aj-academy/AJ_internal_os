        ...
        <div className="flex min-w-0 items-center gap-1.5 sm:gap-2.5">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex min-w-0 items-center gap-2 sm:gap-2.5">
              <span className="inline-flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-[#e8dcc8] bg-white p-0.5 shadow-[0_1px_2px_rgba(61,52,40,0.04)] sm:h-10 sm:w-10">
                <AppLogo size={36} className="h-7 w-7 sm:h-9 sm:w-9" />
              </span>
              <div className="min-w-0">
                <p className="truncate text-sm font-semibold tracking-tight text-[#3d3428]">AJ Academy</p>
                <p className="truncate text-[11px] leading-4 text-[#6b5d4d] sm:text-xs">
                  <span className="font-medium text-[#3d3428]">{fullName}</span>
                  <span className="hidden text-[#a68b2e]/50 sm:inline"> · </span>
                  <span className="hidden break-all sm:inline sm:break-normal">{email}</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex shrink-0 items-center gap-0.5 sm:gap-1.5">
            ...
            <Avatar className="hidden h-9 w-9 shrink-0 border border-[#e8dcc8] bg-[#faf3e3] sm:flex sm:h-10 sm:w-10">
            ...
            <Button
              ...
              disabled={logoutBusy}
              onClick={() => void handleLogout()}
              className="touch-target h-9 w-9 rounded-xl border-[#e8dcc8] bg-white text-[#a68b2e] sm:hidden"
              aria-label="Log out"
              title="Notifications will continue on this device"
            >
              <LogOut className="h-4 w-4" />
