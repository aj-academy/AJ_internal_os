...
const HEADER_ALIASES: Record<string, CollegeVisitCsvHeader> = {
  ...
  "whom visited to the college": "Whom Visited to the College",
  "visited by": "Whom Visited to the College",
  visited_by: "Whom Visited to the College",
...
export function parseCollegeVisitMatrix(
  ...
  for (let i = headerRowIndex + 1; i < matrix.length; i += 1) {
    ...
    forms.push({
      ...
      visited_by: cell(cells, idx, "Whom Visited to the College"),
