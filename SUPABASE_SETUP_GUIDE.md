...
- **Last outcome / remarks is append-only** on edit: each save adds a new date-time entry (IST) and keeps previous entries unchanged; history renders as separate boxes in Edit/View. No additional SQL required.
