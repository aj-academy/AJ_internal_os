...
-- Path: BB_internal_SB/task_notifications_columns.sql
...
comment on column public.tasks.assigned_by is 'Profile id of user who created or last reassigned this task; used for completion notifications.';
