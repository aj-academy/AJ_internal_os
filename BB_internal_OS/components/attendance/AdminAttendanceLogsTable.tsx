            ...
            {rows.map((row) => {
              ...
              return (
                <tr key={row.id}>
                  ...
                  <td className="px-5 py-3">{row.locationType}</td>
                  <td className="max-w-[260px] px-5 py-3">{row.checkInAddress}</td>
                  <td className="max-w-[260px] px-5 py-3">{row.checkOutAddress}</td>
                  <td className="px-5 py-3">
                    <button
                      type="button"
                      disabled={pending}
